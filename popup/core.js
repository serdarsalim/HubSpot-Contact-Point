(() => {
  ...
  const dom = {
    ...
    phoneFlagsEnabledInput: document.getElementById("phoneFlagsEnabledInput"),
    sidebarDeclutterEnabledInput: document.getElementById("sidebarDeclutterEnabledInput"),
    composerTemplateSearchEnabledInput: document.getElementById("composerTemplateSearchEnabledInput"),
    hubspotTemplatesEnabledInput: document.getElementById("hubspotTemplatesEnabledInput"),
    phoneFlagsExcludeField: document.getElementById("phoneFlagsExcludeField"),
    phoneFlagsExcludeDropdown: document.getElementById("phoneFlagsExcludeDropdown"),
    phoneFlagsExcludeDropdownBtn: document.getElementById("phoneFlagsExcludeDropdownBtn"),
    phoneFlagsExcludeDropdownPanel: document.getElementById("phoneFlagsExcludeDropdownPanel"),
    phoneFlagsExcludeDropdownSearch: document.getElementById("phoneFlagsExcludeDropdownSearch"),
    phoneFlagsExcludeDropdownList: document.getElementById("phoneFlagsExcludeDropdownList"),
    phoneFlagsExcludedChips: document.getElementById("phoneFlagsExcludedChips"),
    openContactsInBackgroundInput: document.getElementById("openContactsInBackgroundInput"),
    ...
    contactWidgetInfoBtn: document.getElementById("contactWidgetInfoBtn"),
    contactWidgetInfoOverlay: document.getElementById("contactWidgetInfoOverlay"),
    contactWidgetInfoCloseBtn: document.getElementById("contactWidgetInfoCloseBtn"),
    countryCodeInfoBtn: document.getElementById("countryCodeInfoBtn"),
    countryCodeInfoOverlay: document.getElementById("countryCodeInfoOverlay"),
    countryCodeInfoCloseBtn: document.getElementById("countryCodeInfoCloseBtn"),
    backgroundTabInfoBtn: document.getElementById("backgroundTabInfoBtn"),
    backgroundTabInfoOverlay: document.getElementById("backgroundTabInfoOverlay"),
    backgroundTabInfoCloseBtn: document.getElementById("backgroundTabInfoCloseBtn"),
    ...
    emailTemplatesSearchInput: document.getElementById("emailTemplatesSearchInput"),
    emailCloudToggleWrap: document.getElementById("emailCloudToggleWrap"),
    emailCloudToggleInput: document.getElementById("emailCloudToggleInput"),
    ...
    whatsappTemplatesSearchInput: document.getElementById("whatsappTemplatesSearchInput"),
    whatsappCloudToggleWrap: document.getElementById("whatsappCloudToggleWrap"),
    whatsappCloudToggleInput: document.getElementById("whatsappCloudToggleInput"),
    ...
    noteTemplatesSearchInput: document.getElementById("noteTemplatesSearchInput"),
    noteCloudToggleWrap: document.getElementById("noteCloudToggleWrap"),
    noteCloudToggleInput: document.getElementById("noteCloudToggleInput"),
  ...
  const DEFAULT_SETTINGS = {
    ...
    composerTemplateSearchEnabled: true,
    hubspotTemplatesEnabled: true,
    emailTemplatesShowCloud: true,
    whatsappTemplatesShowCloud: true,
    noteTemplatesShowCloud: true,
    visibleColumns: {},
    columnWidths: {},
    columnOrder: [],
  ...
  const state = {
    ...
    whatsappTemplatesSearchQuery: "",
    whatsappTemplatesShowCloud: true,
    noteTemplatesDraft: [],
    activeNoteTemplateId: "",
    syncingNoteTemplateForm: false,
    noteTemplatesSearchQuery: "",
    noteTemplatesShowCloud: true,
